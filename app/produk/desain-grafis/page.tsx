        ...
        <section className="mx-auto max-w-[1400px] px-6 py-8 lg:px-10">
            ...
            <div className="mt-10 max-w-3xl">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h1 className="text-3xl font-bold sm:text-5xl">
                            Desain <span className="text-red-500">Grafis</span>
                        </h1>
                ...
                <p className="mt-6 text-sm leading-7 text-zinc-300 sm:text-base">
                    Solusi desain grafis untuk berbagai kebutuhan visual,
                    baik untuk media cetak maupun digital.
                </p>
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.025] p-6">
                    ...
                    Visual yang disesuaikan dengan kebutuhan,
                    identitas dan tujuan komunikasi Anda.
                    </p>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.025] p-6">
                    ...
                    <ul className="mt-4 space-y-3 text-sm leading-6 text-zinc-300">
                        ...
                        <li>• Kebutuhan desain lainnya</li>
                    </ul>
            ...
            <h2 className="text-xl font-semibold">
                Konsultasikan kebutuhan <span className= "text-red-500">desain Anda</span>
            </h2>

            <p className="mt-2 text-sm leading-6 text-zinc-300">
                Ceritakan kebutuhan Anda dan mari wujudkan desain
                yang sesuai dengan ide Anda.
            </p>

            <a
                href="https://wa.me/6281351919309?text=Type%20Order%20%3A%20DESAIN%20GRAFIS%0A%0AHi%20Daha.Stampart%2C%0Amau%20konsultasi%20desain%20nih%0A%0ASaya%20%3A%20%0AJenis%20desain%20%3A%20%0ADeskripsi%20%3A%20%0A%28jelaskan%20design%20yg%20anda%20inginkan%29%0A%0AThanks"
                target="_blank"

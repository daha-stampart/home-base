...
export default function MotorPage() {
  ...
  const loadVendors = useCallback(async () => {
    try {
      ...
      const data = await fetchGoogle("motor");

      console.log("VENDOR MOTOR:", data);
  ...
  const handleOpenVendor = () => {
    ...
    // Kalau sebelumnya gagal / belum ada data,
    // coba load ulang ketika modal dibuka.
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-md flex-col justify-center gap-5 px-5 py-8">
        ...
        <button
          ...
          className={`
            ...
            ${
              selectedVendor
                ? "bg-red-600 active:bg-red-700 hover:bg-red-500"

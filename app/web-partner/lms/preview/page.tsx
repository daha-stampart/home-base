    ...
    <main className="min-h-screen bg-[#07090f] text-white">
      ...
      <section className="px-4 pb-14 pt-6">
        ...
        <p className="dashboard-enter mt-3 max-w-md text-sm leading-6 text-zinc-400">
          Website untuk publik maupun admin perpustakaan
          untuk melihat daftar buku, meminjam buku, maupun mengelola buku.
        </p>
        ...
        <div className="mt-7">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            ...
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4">
              ...
              <p className="mt-1 text-[11px] leading-5 text-zinc-500">
                Berbagai kategori, judul serta penulis buku
                diseluruh dunia.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4">
              ...
              <p className="mt-1 text-[11px] leading-5 text-zinc-500">
                Data buku tersusun dengan rapi
                dan mudah dikelola oleh admin
              </p>
            ...
            <div className="mt-5 mb-5 flex justify-center">
              <div className="w-[95%] overflow-hidden rounded-4xl border border-white/[0.08] bg-black/40">
                <button
                  type="button"
                  onClick={() =>
                  setSelectedImage("/images/lms/lms-2.png")
                  }
                  className="block w-full scale-110 cursor-pointer"
                  >
                  <img
                    src="/images/lms/lms-2.png"
            ...
            <div className="mt-5 mb-5 flex justify-center">
              <div className="w-[95%] overflow-hidden rounded-4xl border border-white/[0.08] bg-black/40">
                <button
                  type="button"
                  onClick={() =>
                  setSelectedImage("/images/lms/lms-3.png")
                  }
                  className="block w-full scale-110 cursor-pointer"
                  >
                  <img
                    src="/images/lms/lms-3.png"
                    alt="Preview Otolink Digital Appraisal - Portrait 2"
                    className="block w-full object-contain"
                  />
                </button>

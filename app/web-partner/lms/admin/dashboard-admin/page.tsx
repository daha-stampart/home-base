        ...
        <main className="min-h-screen bg-slate-100">
            <div className="mx-auto min-h-screen w-full max-w-md bg-white">
                ...
                <section className="px-4 pt-6">
                    ...
                    <div className="rounded-2xl bg-blue-600 p-5 text-center text-white shadow-[0_8px_25px_rgba(37,99,235,0.2)]">

                        <div className="flex mx-auto h-11 w-11 items-center justify-center rounded-xl bg-white/15">
                            <ShieldCheck
                                size={20}
                                strokeWidth={2}
                            />
                        ...
                        <p className="mt-1 text-[11px] text-blue-100">
                            Panel pengelolaan Azhar Library
                        </p>

                    </div>

                    {/* TEMPORARY INFO */}
                    <div className="mt-4 rounded-xl border border-dashed border-slate-200 bg-slate-50 p-2 text-center">
                        ...
                        <p className="mt-1 text-[11px] text-slate-400">
                            Pengelolaan dan peminjaman buku
                        </p>
                    ...
                    <button
                        ...
                        <div>
                            <p className="text-[16px] font-bold px-3 text-slate-800">
                                Tambah Buku
                            </p>

                            <p className="mt-0.5 text-[11px] px-3 text-slate-400">
                    ...
                    <button
                        ...
                        <div className="min-w-0">
                            <p className="text-[16px] px-3 font-bold text-slate-800">
                                Hapus Buku
                            </p>
                    ...
                    <button
                        ...
                        onClick={() =>
                            router.push(
                                "/web-partner/lms/admin/dashboard-admin/pengembalian"
                            )
                        }
